	 ...
	 if(($tgtohdl > $tgtohdlnewrangemin)&&($tgtohdl < $tgtohdlnewrangemax)){
	   ...
	   $totalval = $lowbpnewpoint+$highbpnewpoint+$totalcholnewpoint+$ldlcholnewpoint+$hdlcholnewpoint+$triglynewpoint+$nonhdlcnewpoint+$tgtohdlnewpoint;
		 $totalper = ($totalval/16)*100;
			 ...
			 $qry=" Update hd_check_output set Date='".$date."',Age='".$_POST["age"]."', Gender='".$_POST["gender"]."',LowBP='".$_POST["lowbp"]."',HighBP='".$_POST["highbp"]."',TChol='".$_POST["totalchol"]."',LDLChol='".$_POST["ldl"]."',HDLChol='".$_POST["hdl"]."',Triglycerides='".$_POST["triglycerides"]."',NonHDLC='".$_POST["nonhdlc"]."',TGtoHDL='".$_POST["tgtohdl"]."' where Case_ID='".$_POST["caseid"]."' And Patient_ID='".$_SESSION["hduid"]."'  ";
			...
			if(mysqli_query($con,$qry)){
				 if($totalper==0){
					 echo "Result Not Found";
					  ...
					  echo $totalper."% chances of Heart Attack";
				 }
			}
			else{
				echo "Error";
